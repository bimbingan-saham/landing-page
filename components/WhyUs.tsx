...
const features = [
  {
    ...
    title: "Diajar Langsung Dosen S3",
    desc: "Bukan influencer atau trader biasa. Instruktur memiliki latar belakang akademis Ekonomi-Akuntansi yang kuat dan sedang menempuh S3.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
const features = [
  {
    ...
    title: "Dibimbing Sampai Ngerti Laporan Keuangan",
    desc: "Bukan sekadar tau, tapi benar-benar paham cara membacanya untuk analisis saham.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Belajar di Pace-mu Sendiri",
    desc: "Ulang materi kapan pun sampai kamu benar-benar paham, akses seumur hidup.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: "Tanpa Jargon yang Bikin Pusing",
    desc: "Bahasa sederhana, fokus ke yang penting saja — kamu bukan akuntan.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: "Framework praktis untuk menemukan katalis pertumbuhan dari laporan keuangan.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <ScrollReveal className="text-center mb-14">
          ...
          <p className="text-white/60 text-lg max-w-xl mx-auto">
            Kami tidak sekadar mengajarkan saham. Kami membimbingmu sampai benar-benar bisa membaca laporan keuangan dan memilih saham sendiri.
          </p>
        </ScrollReveal>

          ...
          <div className="order-2 md:order-1">
            <ScrollReveal>
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 border border-white/20 rounded-full text-xs font-semibold text-white/90 uppercase tracking-widest mb-6">
                ✦ Catalyst Analysis · Metode Eksklusif
              </span>
            </ScrollReveal>
            ...
            <ScrollReveal delay={1}>
              <h1 className="font-display text-4xl sm:text-5xl lg:text-[3.5rem] leading-[1.15] font-bold text-white mb-6">
                ...
                <span className="text-[#e8b4b4] italic">Insider News.</span>
                <br />
                Kamu Cuma Belum Tau Cara Bacanya.
              </h1>
            </ScrollReveal>

            <ScrollReveal delay={2}>
              <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
                Catalyst Analysis adalah metode untuk menemukan katalis pertumbuhan
                perusahaan — salah satunya tersembunyi di laporan keuangan. Pelajari
                cara membacanya tanpa harus jadi akuntan, hanya bagian yang
                benar-benar penting.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={1} className="w-full max-w-sm md:max-w-none">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/40 aspect-[3/4] max-h-[500px] md:max-h-none">
                ...
                <div className="absolute top-4 left-4">
                  <div className="bg-[#651818]/90 backdrop-blur-sm border border-[#651818] rounded-xl px-3 py-2 shadow-lg max-w-[180px]">
                    <p className="text-white text-xs font-bold">📈 STUDI KASUS</p>
                    <p className="text-white/75 text-[10px] mt-0.5 leading-snug">Saham yang naik 300%+ — terdeteksi dari laporan keuangan sebelum viral</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>

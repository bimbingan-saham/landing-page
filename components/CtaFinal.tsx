      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <ScrollReveal delay={2}>
          <p className="text-white/70 text-lg sm:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
            Ribuan keputusan investasi dimulai dari satu langkah.{" "}
            <span className="text-white">Jadilah yang pertama.</span>
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={3}>
          <a
            ...
            className="inline-flex items-center gap-3 px-10 py-4.5 bg-white text-[#172A5B] font-bold text-base rounded-xl shadow-2xl shadow-black/30 hover:shadow-white/10 hover:-translate-y-1 transition-all duration-200"
